...
export default function Faqs() {
  return (
    <>
      <PageHeader title="FAQs" path="/" link="Home" />
      <section className="accordion">
        ...
        >
          Wear comfortable clothing that allows for ease of movement. Depending
          on the nature of your treatment, your therapist may recommend specific
        ...
        >
          ...
          will provide more specific information during your initial
          consultation.
        </AccordionItem>
        <AccordionItem
          id={4}
        ...
        >
          ...
          including musculoskeletal issues, injuries, and rehabilitation. We
          also offer specialized services such as acupuncture, IMS, and pelvic
          floor physiotherapy.
        </AccordionItem>
        ...
        >
          ...
          protocols, including enhanced sanitation, social distancing, and the
          use of personal protective equipment. Please contact us if you have
          specific concerns or questions regarding our safety measures.
        </AccordionItem>
      </section>
    </>
  );
